    ...
    return (
      <div className="w98-inset-dark bg-inset-well p-4 animate-slide-up">
        <div className="flex flex-col items-center gap-2 py-2">
          <span className="text-hd-14 text-bevel-dark/85 select-none">{"\u266B"}</span>
          <div className="text-hd-13 md:text-hd-11 text-bevel-dark text-center">
            Queue is empty
          </div>
          <div className="text-hd-13 md:text-hd-10 text-bevel-dark/85 text-center leading-relaxed">
    ...
    <div className="w98-inset-dark bg-inset-well animate-slide-up">
      <div className="flex items-center justify-between px-3 py-1.5 border-b border-bevel-dark/15">
        <div className="flex items-center gap-2">
          <span className="text-hd-13 md:text-hd-11 text-bevel-dark/85">
            {queue.length} track{queue.length !== 1 ? "s" : ""}
          </span>
          {remainingMinutes > 0 && (
            <span className="text-hd-11 md:text-hd-10 text-bevel-dark/85 tabular-nums">
      ...
      {savingPlaylist && (
        <div className="flex items-center gap-1.5 px-3 py-1.5 border-b border-bevel-dark/15 bg-midnight/50">
          ...
          <button
            ...
            className="text-hd-12 md:text-hd-10 text-static-green disabled:text-bevel-dark/85 cursor-pointer"
          >
            Save
          </button>
          <button
            onClick={() => setSavingPlaylist(false)}
            className="text-hd-12 md:text-hd-10 text-bevel-dark/85 cursor-pointer"
          >
            Cancel
          </button>
        </div>
            ...
            >
              ...
              <div className="flex flex-col gap-0.5 md:hidden flex-shrink-0">
                <button
                  ...
                  disabled={i === 0}
                  className="text-hd-10 text-bevel-dark/85 active:text-desktop-gray disabled:opacity-20 cursor-pointer px-1"
                  aria-label="Move up"
                >
                  {"\u25B2"}
                </button>
              ...
              {isCurrent && (
                <span className="text-hd-12 md:text-hd-10 text-static-green/85 flex-shrink-0">
                  {"\u25B6"}
                </span>
              )}
