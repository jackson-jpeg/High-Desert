    ...
    return (
      <div className={cn("flex items-center gap-1", className)}>
        <input
          ...
          className="bg-inset-well w98-inset-dark px-2 py-1.5 md:px-1.5 md:py-0.5 text-hd-16 md:text-hd-10 text-desktop-gray outline-none flex-1 md:w-[100px] md:flex-initial"
        />
        <button
          onClick={handleAdd}
...
export function BookmarkList({
  ...
  return (
    <div className={cn("flex flex-col gap-0.5", className)}>
      <div className="text-hd-11 md:text-hd-8 text-desert-amber uppercase tracking-wider font-bold mb-0.5">
        Bookmarks
      </div>
      {bookmarks.map((bm) => (
