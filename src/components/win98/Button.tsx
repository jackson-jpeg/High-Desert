    ...
    return (
      <button
        ...
        className={cn(
          ...
          // Pressed, the label moves one pixel down and right — the Win98 look —
          // by shifting padding between sides, never adding to it. The pressed
          // padding used to be md's numbers for every size, so a small button
          // grew 16×4 px on mousedown; at the end of a wrapping row it could
          // jump to the next line under the pointer, and the click was lost.
          size === "sm" && [
            "px-3 py-2.5 text-hd-12 min-h-touch min-w-0 md:px-2 md:py-0.5 md:text-hd-10 md:min-h-0",
            "md:active:pt-[3px] md:active:pb-[1px] md:active:pl-[9px] md:active:pr-[7px]",
          ],
          size === "md" && [
            "px-4 py-2.5 text-hd-13 min-h-touch min-w-[75px] md:py-1 md:text-hd-11 md:min-h-0",
            "md:active:pt-[5px] md:active:pb-[3px] md:active:pl-[17px] md:active:pr-[15px]",
          ],
          size === "lg" && [
            "px-6 py-3 text-hd-14 min-h-touch min-w-[90px] md:py-1.5 md:text-hd-12 md:min-h-0",
            "md:active:pt-[7px] md:active:pb-[5px] md:active:pl-[25px] md:active:pr-[23px]",
          ],
          className,
        )}
        {...props}
