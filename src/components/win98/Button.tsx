    ...
    return (
      <button
        ...
        className={cn(
          ...
          size === "sm" && "px-3 py-2.5 text-hd-12 min-h-touch min-w-0 md:px-2 md:py-0.5 md:text-hd-10 md:min-h-0",
          size === "md" && "px-4 py-2.5 text-hd-13 min-h-touch min-w-[75px] md:py-1 md:text-hd-11 md:min-h-0",
          size === "lg" && "px-6 py-3 text-hd-14 min-h-touch min-w-[90px] md:py-1.5 md:text-hd-12 md:min-h-0",
          className,
        )}
        {...props}
      >
