...
export const MUTATIONS = [
  ...
  // failure in the test leaves a half-done delete behind.
  {
    ...
    test: "src/services/episodes/__tests__/delete-episode.test.ts",
    file: "src/services/episodes/management.ts",
    find: 'await db.transaction("rw", [db.episodes, db.history, db.bookmarks, db.playlists, db.userPrefs], async () => {',
  ...
  },
  {
    ...
    file: "src/services/episodes/management.ts",
    find: 'await db.transaction("rw", [db.episodes, db.scanSessions, db.history, db.bookmarks, db.playlists, db.userPrefs], async () => {',
    replace: "await (async (run: () => Promise<void>) => run())(async () => {",
