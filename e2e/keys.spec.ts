 ...
 *
 * Plays are counted from the play request the library dispatches
 * (`hd:play-episode`), installed before any app code runs. Each "nothing
...
async function countPlays(page: Page) {
  await page.addInitScript(() => {
    ...
    window.addEventListener("hd:play-episode", () => {
